...
class AnimeControllerTest {
	...
	void setUp() {
		...
		BDDMockito.when(animeServiceMock.findByIdOrThrowBadResquestException(ArgumentMatchers.anyLong()))
		...
		BDDMockito.doNothing().when(animeServiceMock).replace(ArgumentMatchers.any(Anime.class));
