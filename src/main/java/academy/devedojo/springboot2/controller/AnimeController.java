package academy.devedojo.springboot2.controller;
...
import academy.devedojo.springboot2.mapper.AnimeMapper;
...
import academy.devedojo.springboot2.service.AnimeService;
...
public class AnimeController {
	...
	public ResponseEntity<Anime> save(@RequestBody @Valid AnimePostRequestBody animePostRequestBody) {
		return new ResponseEntity<>(animeService.save(
				AnimeMapper.INST_ANIME_MAPPER.toAnime(animePostRequestBody)), 
				HttpStatus.CREATED);
	}
	...
	public ResponseEntity<Void> replace(@RequestBody AnimePutRequestBody animePutRequestBody) {
		animeService.replace(AnimeMapper.INST_ANIME_MAPPER.toAnime(animePutRequestBody));
		return new ResponseEntity<>(HttpStatus.NO_CONTENT);
	}
